...
googletag.cmd.push(function () {
  ...
  // BANNER (HIDE MOBILE) SIZING
  var bannerTopMapping = googletag.sizeMapping()
    .addSize([0, 0], [])
    .addSize([768, 1], [728, 90])
    .build();
  ...
  googletag.defineSlot('/5805113/TexasTribune_Site_Roofline1_ATF_Leaderboard_728x90', [728, 90], 'ad-banner-leader')
    .defineSizeMapping(bannerTopMapping)
    .addService(googletag.pubads());

  // googletag.defineSlot('/5805113/TexasTribune_Content_StoryLanding_ATF_RightRail1_MediumRectangle_300x250', [300, 250], 'ad-sidebar')
